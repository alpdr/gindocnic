...
func Example() {
	...
	//             application/json:
	//               schema:
	//                 $ref: '#/components/schemas/GindocnicTestResponse'
	//           description: OK
	//         "404":
	//           content:
	//             application/json:
	//               schema:
	//                 $ref: '#/components/schemas/GindocnicTestErrorResponse'
	...
	//           application/json:
	//             schema:
	//               $ref: '#/components/schemas/GindocnicTestAddPetRequest'
	//       responses:
	//         "201":
	//           content:
	//             application/json:
	...
	//       - id
	//       type: object
	//     GindocnicTestErrorResponse:
	//       properties:
	//         error:
	//           type: string
	//       type: object
	//     GindocnicTestResponse:
	//       properties:
	//         id:
	//           type: integer
	//       type: object
